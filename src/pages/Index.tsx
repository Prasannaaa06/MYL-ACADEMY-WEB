...
const courses = [
  {
    ...
    description: "Master modern web development with HTML, CSS, JavaScript, React, and Node.js. Build responsive, dynamic websites and web applications.",
    duration: "12 weeks",
    students: 2340,
    rating: 4.8,
  },
  {
    id: "data-science",
    title: "Data Science",
    description: "Learn data analysis, machine learning, and statistical modeling using Python, pandas, and scikit-learn to extract insights from data.",
    duration: "16 weeks",
    students: 1850,
    rating: 4.7,
  },
  {
    ...
    description: "Discover SEO, social media marketing, content strategy, and analytics to grow your online presence and drive business results.",
    duration: "8 weeks",
    students: 3120,
    rating: 4.6,
  },
  {
    ...
    description: "Create stunning visual designs using Adobe Creative Suite, typography principles, and brand identity development techniques.",
    duration: "10 weeks",
    students: 1960,
    rating: 4.9,
  },
  {
    ...
    description: "Build native mobile apps for iOS and Android using React Native, Flutter, or native development frameworks and tools.",
    duration: "14 weeks",
    students: 1450,
    rating: 4.7,
  },
